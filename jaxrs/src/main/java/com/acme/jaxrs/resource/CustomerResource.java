...
public class CustomerResource
{
   ...
   /**
    * This method responds to a GET request that supports the content type
    * application/xml or application/json and returns the requested customer
    * resource.
    * 
    * <p>
    * The customer is retrieved by id. A representation of the customer is then
    * written into the response in the requested format. The id value is taken
    * from the final path segment.
    * </p>
    * 
    * <a class="citation" href=
    * "javacode://com.acme.jaxrs.CustomerResource#getCustomerById(java.lang.String)"
    * />
    */
   @GET
   @Path("/{id:[1-9][0-9]*}")
    ...
    * 
    * <p>
    * The customer is retrieved by name. A representation of the customer is
    * then written into the response in the requested format. The name value is
    * taken from the final path segment.
    * </p>
    * 
    * <a class="citation" href=
    * "javacode://com.acme.jaxrs.CustomerResource#getCustomerByName(java.lang.String)"
    * />
    */
   @GET
   @Path("/{name}")
